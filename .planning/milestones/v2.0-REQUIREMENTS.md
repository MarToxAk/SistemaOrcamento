...
## v2.0 Phase Requirements (tracked in ROADMAP.md)

Requirements for v2.0 phases were defined directly in ROADMAP.md phase sections:

| REQ-ID | Phase | Description | Status |
|--------|-------|-------------|--------|
| CAIXA-01..04 | 23 | Hardening AthosListenerService | COMPLETE |
| CPAG-01..04 | 24 | API Contas a Pagar POST/GET/PATCH | COMPLETE |
| ANEX-01..03 | 25 | Upload de anexos via SMB | COMPLETE |
| CR-01..05 | 27 | Dashboard de Contas a Receber | COMPLETE |
