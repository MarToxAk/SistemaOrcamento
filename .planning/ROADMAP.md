...
Version: 1.9 (milestone complete)
Date: 2026-05-05
...
- [x] v1.9 Webhook EFI PIX e Robustez de URLs - Phase 22 (shipped 2026-05-05)
...
## v1.9 Webhook EFI PIX e Robustez de URLs (Phase 22) - SHIPPED 2026-05-05

Full details: .planning/milestones/v1.9-ROADMAP.md

- [x] Phase 22: Correcao webhook EFI /pix e robustez NfseService (EFIWH-01, EFIWH-02, EFIWH-03)
## Backlog (Future)
