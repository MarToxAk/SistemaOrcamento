...
<style>
  ...
  :root {
    ...
    --paper:#f8fafc; --total-red:#c2362c; --brand-red:#ee3537;
  ...
  *{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact}
  ...
  /* Decorative pencil strips — only rendered when URLs are provided */
  ...
  .page{position:relative;z-index:2;padding:14mm 14mm 14mm}
  .page.has-strips{padding-top:calc(var(--strip-h) + 10mm);padding-bottom:calc(var(--strip-h) + 6mm)}
...
{{#if pencilsTopUrl}}<img src="{{pencilsTopUrl}}" class="pencils-top" alt="">{{/if}}
{{#if pencilsBottomUrl}}<img src="{{pencilsBottomUrl}}" class="pencils-bottom" alt="">{{/if}}
...
<div class="page{{#if pencilsTopUrl}} has-strips{{/if}}">
  ...
  <table class="items">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="num">{{valoritem}}</td>
        <td class="num">{{orcamentovalorfinalitem}}</td>
        <td class="num total">{{orcamentovalorfinalitem}}</td>
      </tr>
      {{/each}}
    </tbody>
  </table>
  ...
  <div class="foot-row">
    ...
    <div class="totals">
      <div class="totals__row"><span>Valor original</span><b>{{totais.valor}}</b></div>
      <div class="totals__row totals__row--disc"><span>Desconto</span><b>{{#if totais.desconto}}{{totais.desconto}}{{else}}Isento{{/if}}</b></div>
      <div class="totals__row totals__row--grand"><span>Total</span><b>{{totais.valor}}</b></div>
    </div>
  </div>
