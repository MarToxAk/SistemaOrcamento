...
# Emojis as Python unicode escapes (\UXXXXXXXX format)
emojis = {
    "pendente":            "\U0001F550",  # clock
    "enviado":             "\U0001F4E4",  # outbox
    "aprovado":            "\u2705",       # check
    "pagamento_parcial":   "\U0001F4B0",  # money bag
    "em_producao":         "\U0001F3A8",  # palette
    "pronto_para_entrega": "\U0001F4E6",  # box
    "entregue":            "\U0001F389",  # party
    "cancelado":           "\u274C",       # x
}

# Build STATUS_INFO lines
status_lines = [
